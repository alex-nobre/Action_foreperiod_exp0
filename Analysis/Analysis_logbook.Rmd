...
A variância explicada, tanto pelos efeitos fixos quanto pelo modelo, é superior para o modelo utilizando dados limpos, com uma pequena vantagem para o modelo com logRT.
...
O modelo com 1/RT e com dados limpos se comporta melhor, seguido pelo modelo com logRT e dados limpos, com uma diferença pequena.
...
Com exceção do modelo com RT como variável dependente, para o qual os resíduos parecem se correlacionar com os valores ajustados, não parece haver problemas com os modelos.

No geral, podemos observar que:
* a remoção de valores altamente influentes melhora o ajuste e a distribuição dos resíduos;
* o modelo com RT bruto tem o pior desempenho em todas as métricas;
* o modelo com 1/RT provê resíduos mais bem comportados, mas o modelo com logRT explica uma variância maior nos dados.
